...
本模块用于沉淀 DevOps、Kubernetes、监控告警、CMDB、统一身份认证和发布系统方向的技术文档、排障 Runbook 与设计说明。
...
- 将 FreeIPA、Keycloak、OIDC 和应用权限映射沉淀为统一身份认证实战手册。
...
├── cmdb/               # CMDB 和运维平台文档
├── monitoring/         # 监控告警文档
├── sso/                # FreeIPA、Keycloak 与应用 SSO 实战
...
- [FreeIPA + Keycloak 企业级 SSO 单点登录实战](sso/freeipa-keycloak-sso.md)
